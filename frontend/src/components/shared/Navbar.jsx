            ...
            <div className="flex items-center justify-between mx-auto max-w-7xl h-16 px-6">
                ...
                <div className="flex items-center gap-8">
                    ...
                    {!user ? (
                        ...
                        <Button
                    variant="outline"
                      className="border border-gray-300 text-blue px-4 py-2 rounded-lg transition duration-300 ease-in-out hover:bg-white hover:text-indigo-600 hover:shadow-lg"
                                     >
                                    Login
                                     </Button>
                        ...
                        <Link to="/signup">
                            <Button className="border border-gray-300 text-blue px-4 py-2 rounded-lg transition duration-300 ease-in-out hover:bg-white hover:text-indigo-600 hover:shadow-lg">
                                Signup
                            </Button>
                        </Link>
                    </div>
